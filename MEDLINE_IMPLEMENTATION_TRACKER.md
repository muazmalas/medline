...
- [x] Split administrator partner management into separate Pharmacies and Warehouses navigation/table views, added backend partner-type filtering, and preserved role-assignment company fields in the admin users API. React coverage remains above 50%; targeted Laravel authorization tests pass.
